...
const Footer = () => {
    return (
        <div>
            ...
            <div
                className="relative mx-auto px-4 py-16 sm:px-6 lg:px-12 lg:pt-24"
            >
                <div className="absolute end-4 top-4 sm:end-6 sm:top-6 lg:end-8 lg:top-8">
                <a
                    className="inline-block rounded-full bg-[#c03221] p-2 text-white shadow transition hover:bg-teal-500 sm:p-3 lg:p-4"
                    href="#MainContent"
                >
            ...
            <ul className="mt-12 flex justify-center lg:justify-start gap-6 md:gap-8">
                <li>
                    <a
                    href="/"
                    rel="noreferrer"
